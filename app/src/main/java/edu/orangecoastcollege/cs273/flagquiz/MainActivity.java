...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Country> mFilteredCountryList; // countries filtered by selected region
    ...
    public void resetQuiz() {
        ...
        int flagCounter = 1;
        int numberOfFlags = mFilteredCountryList.size();
        ...
        while (flagCounter <= FLAGS_IN_QUIZ) {
            ...
            Country randomCountry = mFilteredCountryList.get(randomIndex);
    ...
    // Override onCreateOptionsMenu to inflate the setting menu

    @Override
    // Inflated the Settings menu within MainActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Make new Intent going to SettingsActivity
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            switch (key) {
                case CHOICES:
                    ...
                    // Call methods to update choices (visually)
                    updateChoices();
                    resetQuiz();
                    break;
                case REGIONS:
            ...
            // Notify the use that the quiz will restart
    ...
    private void updateRegions() {
        ...
        else
        {
            ...
            for (Country c : mAllCountriesList)
                if (c.getRegion().equals(mRegion)) // if the regions match
